...
<script>
	...
	function backToList(object) {
		...
		object.form.action="http://localhost:8080/pro17_1/board";
		object.form.submit();
	}
</script>
</head>
<body>
	...
	<form name="articleForm" method="post"
		action="http://localhost:8080/pro17_1/board/addArticle.do"
		...
		<table border=0 align="center">
			...
			<tr>
				...
				<td colspan="2"><input type="submit" value="글쓰기" /> <input
					type=button value="목록보기" onClick="backToList(this)" /></td>
			</tr>
		</table>
	</form>
